                    ...
                    <div id="myCarousel" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="row">
                                    <div class="span6">
                                        <img src="{{ asset('UI/themes/images/carousel/carousel2.jpg') }}" alt="#" />
                                    </div>
                                    <div class="span6">
                            ...
                            <div class="item">
                                <div class="row">
                                    <div class="span6">
                                        <img src="{{ asset('UI/themes/images/carousel/carousel3.jpg') }}" alt="#" />
                                    </div>
                                    <div class="span6">
                                        <div class="promoDetail">
                ...
                <div id="showCase" class="row">
                    <div class="span2">
                        <div class="carousel slide">
                            <div class="carousel-inner">
                                <div class="item active">
                                    <a  href="details.php" ><img src="{{ asset('UI/themes/images/clothes/sma6.jpg') }}" alt="#"/>
                                        View Details</a>
                                </div>
                                <div class="item">
                                    <a  href="details.php" ><img src="{{ asset('UI/themes/images/clothes/sma5.jpg') }}" alt="#"/>
                                        View Details</a>
                                </div>
                                <div class="item">
                                    <a  href="details.php" ><img src="{{ asset('UI/themes/images/clothes/sma4.jpg') }}" alt="#"/>
                                        View Details</a>
                                </div>
                                <div class="item">
                                    <a  href="details.php" ><img src="{{ asset('UI/themes/images/clothes/sma3.jpg') }}" alt="#"/>
                                        View Details</a>
                                </div>
                                <div class="item">
                                    <a  href="details.php" ><img src="{{ asset('UI/themes/images/clothes/sma2.jpg') }}" alt="#"/>
                                        View Details</a>
                                </div>
                                <div class="item">
                                    <a  href="details.php" ><img src="{{ asset('UI/themes/images/clothes/sma1.jpg') }}" alt="#"/>
                                        View Details</a>
                                </div>
                            </div>
                        </div>
